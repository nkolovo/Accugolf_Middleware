    ...
    public class SportProfileRegistry
    {
        ...
        private void LoadBuiltins()
        {
            Register(new SportProfile
            {
                ...
                // 3 m/s: comfortably below the "10-30 m/s typical" floor below
                // (room for a genuinely weak shot/pass) but well above a hand
                // repositioning the ball at the spot — see SportProfile.MinSpeedMps.
                MinSpeedMps = 3, MaxSpeedMps = 60,
            ...
            Register(new SportProfile
            {
                ...
                MinSpeedMps = 5, MaxSpeedMps = 50, // see SportProfile.MinSpeedMps
            ...
            Register(new SportProfile
            {
                ...
                MinSpeedMps = 5, MaxSpeedMps = 80, // see SportProfile.MinSpeedMps
                OutputSpin = true, OutputLaunchAngle = true,
            ...
            Register(new SportProfile
            {
                ...
                MinSpeedMps = 8, MaxSpeedMps = 50, // see SportProfile.MinSpeedMps
                OutputSpin = false, OutputLaunchAngle = true, // spin not needed for baseball
            ...
            Register(new SportProfile
            {
                ...
                // Kept near 0, unlike the other sports: a putt can be well under
                // 2 m/s, deliberately and legitimately slow — there's no speed
                // floor that separates "a real, gentle putt" from "the ball got
                // nudged while addressing it" the way there is for a sport whose
                // shots are always fast. This mostly just filters out near-zero
                // sensor jitter, not genuine slow repositioning — see
                // SportProfile.MinSpeedMps's caveat.
                MinSpeedMps = 0.5, MaxSpeedMps = 90,
                OutputSpin = true, OutputLaunchAngle = true,
